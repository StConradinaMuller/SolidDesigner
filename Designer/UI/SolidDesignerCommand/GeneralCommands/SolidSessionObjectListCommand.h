...
namespace sdr
{
	/// \brief Implements Backstage: Manage Session -> Object List.
	class SolidSessionObjectListCommand final : public AppCommandBase
	{
	public:
		SolidSessionObjectListCommand() noexcept;
		~SolidSessionObjectListCommand() override;
