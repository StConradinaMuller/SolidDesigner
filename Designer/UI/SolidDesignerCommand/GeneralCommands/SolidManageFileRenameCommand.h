...
namespace sdr
{
	/// \brief Implements Backstage: Manage File -> Rename.
	class SolidManageFileRenameCommand final : public AppCommandBase
	{
	public:
		SolidManageFileRenameCommand() noexcept;
		~SolidManageFileRenameCommand() override;
